...
// used to wrap slow git or hook work - that runs between Do calls (the
// "creating" status plus a grace window keeps an in-flight create hands-off).
